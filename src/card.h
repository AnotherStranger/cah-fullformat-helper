 ...
 *
 * This class is the Base class for both card types (white and black cards) in the game.
 * Both card types do have a text and a category. Moreover both do have a LaTeX and a csv-representation.
 */
...
public:
     ...
     * Note that multiple whitespace will be condensed to one whitespace.
     */
    ...
    /*!
     * \brief sets the cards attributes according to the ones given in the parameter
